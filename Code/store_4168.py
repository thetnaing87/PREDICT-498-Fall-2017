...
directory = os.path.join('C:/MSPA/Capstone/Project/498-20170922T004637Z-001/498/Ticket/store 4168/')
"""
...
store_4168=pd.read_csv(os.path.join(directory,excel_files[0]),encoding='latin-1', sep=',')
...
for i in range(nFiles):
    ...
    store_4168=store_4168.append(store_data)

#remove duplicate records   
store_4168=store_4168.drop_duplicates()

    
store_4168.head()
store_4168.dtypes
print(store_4168.columns)     

# convert object to date
store_4168['BUSINESS_DATE']=pd.to_datetime(store_4168['BUSINESS_DATE'])
store_4168['TICKET_CLOSE_TIME']=pd.to_datetime(store_4168['TICKET_CLOSE_TIME'])
store_4168['TICKET_OPEN_TIME']=pd.to_datetime(store_4168['TICKET_OPEN_TIME'])


# create derived variables for further analysis
store_4168['YEAR']=store_4168['BUSINESS_DATE'].dt.year
store_4168['MONTH']=store_4168['BUSINESS_DATE'].dt.month
store_4168['HOUR']=store_4168['TICKET_OPEN_TIME'].dt.hour
store_4168['WEEK']=store_4168['BUSINESS_DATE'].dt.weekday_name
...
store_4168['HOURLY']=store_4168.apply(hourly,axis=1)
...
store_4168['DAY_PART']=store_4168.apply(daypart,axis=1)
...
store_4168['DAYOFWEEK']=store_4168.apply(dayofweek,axis=1)
...
store_4168['SEASONAL']=store_4168.apply(seasonal,axis=1)

# drop WEEK column
store_4168=store_4168.drop('WEEK', axis=1)
store_4168.head()
store_4168.to_csv(os.path.join(directory,'consolidated_4168.csv'), index=False)
"""
store_4168=pd.read_csv(os.path.join(directory,'consolidated_4168.csv'),encoding='latin-1', sep=',')
store_4168.head()
# separate transactions to products and condiments
condiment_used=store_4168[store_4168['ITEM_PRICE']==0]
actual_sales=store_4168[store_4168['ITEM_PRICE']!=0]
...
seasonal_volume1.to_csv(os.path.join(directory,'volume_trend_analysis_4168.csv'), index=False)
